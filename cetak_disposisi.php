    ...
    if(empty($_SESSION['admin'])){
        ...
        <!-- Container START -->
            <div id="colres">
                <div class="disp">';
                    ...
                    list($institusi, $nama, $status, $alamat, $logo) = mysqli_fetch_array($query2);
                        ...
                        echo '<br>';
                        echo '<span id="alamat">Jalan Jawa No 31 , Gubeng, Surabaya</span>';
                ...
                echo '
                    <table class="bordered" id="tbl">
                        <tbody>
                            <tr>
                                <td class="tgh" id="lbr" colspan="5">LEMBAR SURAT</td>
                            </tr>
                            <tr>
                            ...
                            <tr class="isi">
                                <td colspan="2">
                                    <strong>Isi Surat :</strong><br/>'.$row['isi_disposisi'].'
                                ...
                                echo '
                                <tr class="isi">
                                    <td colspan="2"><strong>Isi Surat :</strong>
                                    </td>
            ...
            <div id="lead">
                ...
                // } else {
                    echo '<p class="lead">Rudy Mahendra</p>';
                // }
                // if(!empty($nip)){
                //     echo '<p>NIP. '.$nip.'</p>';
                // } else {
